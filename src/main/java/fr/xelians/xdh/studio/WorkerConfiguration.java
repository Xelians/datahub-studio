...
import fr.xelians.xdh.studio.form.WorkerForm;
...
public interface WorkerConfiguration {
	 ...
	 * @return the {{@link fr.xelians.xdh.studio.translation.Label.Translation}} use for label translation.
	 */
	...
	/**
	 * The form for the worker configuration. To create the form you can use the {{@link fr.xelians.xdh.studio.form.WorkerFormBuilder}} by calling {{@link WorkerForm#builder() }}.
